    ...
    def transunet_plus2_base(input_tensor: torch.Tensor, filter_num, stack_num_down=2, stack_num_up=2,
        ...
        # backbone cases
            ...
            # for other backbones
                ...
                backbone_ = backbone_zoo(backbone, weights, input_tensor, depth_ - 1, freeze_backbone,
                                         freeze_batch_norm)
                # collecting backbone feature maps
                X_skip = backbone_([input_tensor, ])
...
class transunet_plus2:
    def __init__(self, input_size, filter_num, n_labels, stack_num_down=1, stack_num_up=1,
        ...
        X = transunet_plus2_base(IN, filter_num, stack_num_down=stack_num_down, stack_num_up=stack_num_up,
                                 embed_dim=embed_dim, num_mlp=num_mlp, num_heads=num_heads,
