...
from keras_core.layers import UpSampling2D, Conv2DTranspose, Conv2D, BatchNormalization, Activation, MaxPooling2D
from keras_core.layers import AveragePooling2D
